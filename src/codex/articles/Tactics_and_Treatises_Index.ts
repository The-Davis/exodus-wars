...
export const tacticsAndTreatisesIndexArticle: CodexArticle = {
    id: 74,
    slug: 'Tactics_and_Treatises',
    title: 'Tactics and Treatises',
    author: 'ABailey',
    lastUpdated: '2010-08-26 22:55:31',
    summary: 'The master military doctrine, combat strategy, and philosophical treatise catalog of the Exodus Wars universe, documenting battlefield survivability guidelines, naval doctrine, and foundational interstellar transit essays.',
    categories: ['Tactics and Treatises', 'Tactics', 'Treatises', 'Categories'],
    rawContent: `Many writings on '''Tactics''' have been distributed and studied by the various militaries throughout the galaxy, compiling hard-earned battlefield wisdom from centuries of colonial conflict, naval skirmishes, and existential swarm incursions.

'''Treatises''' are analytical essays and scholarly surveys that focus on vital social, economic, and scientific issues facing society across the interstellar frontier. They synthesize complex operational realities into foundational knowledge for commanders, pilots, and citizens alike.
...
* '''Theories of Modern Naval Warfare (2336 Update)''' - Capital warship fleet engagement doctrine analyzing carrier strike group positioning, missile volley timing, and point-defense screens during fleet-scale actions.
...
* '''On the Origins of the Volucris in the Orion Arm''' - Speculative xenobiological treatise exploring the initial discovery, hive ecology, and migration patterns of the bio-mechanical swarms.
